...
class ReduceViewController:BaseViewController,MyDownloaderDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    func downloadData(){
        ...
        let urlString = String(format: kReduceUrl, arguments: [self.curPage])
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        searchCtrl.type = .SearchTypeReduce
