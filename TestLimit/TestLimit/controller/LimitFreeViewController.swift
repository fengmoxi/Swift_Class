...
class LimitFreeViewController: BaseViewController,MyDownloaderDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell?.configModel(model, index: indexPath.row+1, cutLength: 2)
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        searchCtrl.type = .SearchTypeLimit
