...
class FreeViewController: BaseViewController,MyDownloaderDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    func downloadData(){
        ...
        let urlString = String(format: kFreeUrl, arguments: [self.curPage])
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        searchCtrl.type = .SearchTypeFree
